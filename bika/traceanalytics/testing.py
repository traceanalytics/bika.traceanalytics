...
class BikaTestLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        self.loadZCML(package=bika.traceanalytics)

        # Required by Products.CMFPlone:plone-content
        z2.installProduct(app, 'Products.PythonScripts')
        z2.installProduct(app, 'bika.lims')
        z2.installProduct(app, 'bika.traceanalytics')
    ...
    def setUpPloneSite(self, portal):
        ...
        applyProfile(portal, 'bika.traceanalytics:default')
        ...
        self.request.form['existing'] = "bika.traceanalytics:test"
        lsd = LoadSetupData(portal, self.request)
        lsd()

        logout()

TRACEANALYTICS_TEST_FIXTURE = BikaTestLayer()

BIKA_TRACEANALYTICS_TESTING = FunctionalTesting(
    bases=(TRACEANALYTICS_TEST_FIXTURE, z2.ZSERVER_FIXTURE),
    name="TraceAnalyticsTestingLayer:Robot")
