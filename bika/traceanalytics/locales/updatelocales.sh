#!/bin/bash
# zinstance/src/bika.traceanalytics/bika/traceanalytics/locales
ZINSTANCE=$PWD'/../../../../..'
...
> en/LC_MESSAGES/bika.traceanalytics.po
...
rm bika.traceanalytics.pot 2>/dev/null
...
### bika.traceanalytics domain
DOMAIN=bika.traceanalytics
$I18NDUDE rebuild-pot --pot $DOMAIN-tmp.pot --exclude "build" --create $DOMAIN ..
# smash bika-manual into bika.traceanalytics output,
...
$I18NDUDE sync --pot bika.traceanalytics.pot */LC_MESSAGES/bika.traceanalytics.po
